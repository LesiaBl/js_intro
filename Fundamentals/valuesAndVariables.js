...
console.log(`My name is ${firstName}, nice to meet you`);
...
console.log(
    `    
          JavaScript is a high-level programming language used to build web applications. It is not limited to the web;
    it can also be used for the backend development with technologies like Node.js.

          It is open source and has a huge community support, which means there are plenty of resources and support available for
    learning. It uses a syntex like other programming languages and easy to learn. `
    );
...
let myAge = 25, myFaworiteNumber = 7, myHeight = 158, myWeight = 58, myFavoriteLetter = "L";
console.log(myAge);
console.log(myFaworiteNumber);
...
let num1 = 25, num2 =35, sum = num1+num2;
...
*/
let number1 = 24, number2=10, sum2=number1+number2, product2=number1*number2, 
subtraction= number1-number2, division=number1/number2, remainder=number1%number2;
...
console.log(`The ${b1} multiplaied with ${b1} is = ${b1*b1}`);
console.log(`The ${b2} multiplaied with ${b2} is = ${b2*b2}`);
console.log(`The ${b3} multiplaied with ${b3} is = ${b3*b3}`);
...
let side = 7, area =side * side, perimeter= 4 * side; 
console.log(`The perimeter of the square = ${perimeter}`);
console.log(`The are of the square = ${area}`);
